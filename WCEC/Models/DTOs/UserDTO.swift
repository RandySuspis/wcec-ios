...
class UserDTO: NSObject {
    ...
    var userChannelRoleType: String
    ...
    init(_ json: JSON) {
        ...
        current_locale      = json["current_locale"].stringValue
        push_notification   = json["push_notification"].boolValue
        ...
        pubNubAuthKey       = json["auth_key"].stringValue
        userChannelRoleType = json["channel_role"].stringValue
        verifiedStatus      = json["verify_status"].stringValue
    }
}
