...
extension UIBarButtonItem {
    ...
    class func nextBarButton(target: Any, selector: Selector) -> UIBarButtonItem {
        let barButton = UIBarButtonItem(title: "Next".localized(), style: .plain, target: target, action: selector)
    ...
    class func saveBarButton(target: Any, selector: Selector) -> UIBarButtonItem {
        let barButton = UIBarButtonItem(title: "Save".localized(), style: .plain, target: target, action: selector)
        barButton.setTitleTextAttributes([NSAttributedStringKey.font:AppFont.fontWithType(.regular, size: 14)], for: .normal)
        return barButton
    }
    ...
    class func loginBarButton(target: Any, selector: Selector) -> UIBarButtonItem {
        let barButton = UIBarButtonItem(title: "Login".localized(), style: .plain, target: target, action: selector)
        barButton.setTitleTextAttributes([NSAttributedStringKey.font:AppFont.fontWithType(.regular, size: 14)], for: .normal)
        return barButton
    }
}
