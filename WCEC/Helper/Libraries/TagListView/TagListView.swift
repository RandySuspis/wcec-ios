...
//                currentRowWidth += tagView.frame.width + marginX
    ...
    private func createNewTagView(_ title: String, _ tagId: Int, _ type: TypeSubCategory) -> TagView {
        let tagView = TagView(title: title, tagID: tagId, type: type)
        tagView.textColor = textColor
        tagView.selectedTextColor = selectedTextColor
        tagView.tagBackgroundColor = tagBackgroundColor
        tagView.highlightedBackgroundColor = tagHighlightedBackgroundColor
...
//        }
    ...
    @discardableResult
    open func addTag(_ title: String, _ tagId: Int, _ type: TypeSubCategory) -> TagView {
        return addTagView(createNewTagView(title, tagId, type))
    }
