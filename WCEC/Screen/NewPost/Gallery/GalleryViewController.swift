...
class GalleryViewController: BasePagerViewController {
    ...
    @IBOutlet weak var heightTabPagerConstraint: NSLayoutConstraint!
    ...
    func setupUI() {
        ...
        heightTabPagerConstraint.constant = isOnlyImage ? 0.0 : 58.0
    ...
    override func setupData() -> [UIViewController] {
        ...
        return isOnlyImage ? [photosVC] : [photosVC, videosVC]
    }
