//
//  CheckSocialBeMemberViewController.swift
//  WCEC
//
...
class CheckSocialBeMemberViewController: BaseViewController {
    ...
    @IBAction func onSelectBackToMain(_ sender: Any) {
    ...
    @IBAction func onSelectBeAMember(_ sender: Any) {
        self.dismiss(animated: true, completion: nil)
