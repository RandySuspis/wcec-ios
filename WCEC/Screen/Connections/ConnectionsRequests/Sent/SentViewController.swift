...
class SentViewController: BaseViewController {
    ...
    @objc func getData() {
        ...
        connectionsService.getListRequests(param: "sent",pager: pager) { (result) in
            switch result {
...
extension SentViewController: UITableViewDelegate {
...
extension SentViewController: ConnectionsTableViewCellDelegate {
...
extension SentViewController: PopupSendRequestDelegate {
