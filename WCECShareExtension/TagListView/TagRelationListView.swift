...
//    }
    ...
    private func createNewTagView(_ title: String, _ tagId: Int, _ enableMutual: Bool) -> TagRelationView {
    ...
    @discardableResult
    open func addTag(_ title: String, _ tagId: Int, _ enableMutual: Bool) -> TagRelationView {
        return addTagView(createNewTagView(title, tagId, enableMutual))
    }
