...
protocol MonthYearPickerViewDelegate: NSObjectProtocol {
    func monthYearPickerView(month: Int, year: Int)
}

class MonthYearPickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource {
    
    weak var delegatePicker: MonthYearPickerViewDelegate?
    var months: [String]!
    var years: [Int]!
    ...
    func commonSetup() {
        ...
        self.selectRow(self.years.count - 1, inComponent: 1, animated: false)
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        self.month = month
        self.year = year
        delegatePicker?.monthYearPickerView(month: month, year: year)
    }
